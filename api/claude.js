...
<body style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 32px 24px; background: #f7f4ef; color: #1a1a2e;">
  ...
  <div style="background: #ffffff; border-radius: 16px; padding: 32px; border: 1px solid #e8<span class="ml-2" /><span class="inline-block w-3 h-3 rounded-full bg-neutral-a12 align-middle mb-[0.1rem]" />
