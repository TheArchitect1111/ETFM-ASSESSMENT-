...
export default async function handler(req, res) {
  ...
  // ── CREATE: Save Q1-6 answers and create session ──────────────────────────
  if (action === "create") {
  ...
  if (action === "complete") {
    ...
    // Trigger Deep Dive Report email (non-blocking)
    fetch(`${process.env.VERCEL_URL || "https://etfm-assessment.vercel.app"}/api/claude`, {
      method: "POST",
