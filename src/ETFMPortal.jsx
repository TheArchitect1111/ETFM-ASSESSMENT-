...
const styles = {
  ...
  toolContent: { marginTop: 20, borderTop: "1px solid #1A1A1A", paddingTop: 20 },
  ...
  formIntro: { color: "#555", fontSize: 12, lineHeight: 1.8, marginBottom: 20, fontStyle: "italic" },
  fieldLabel: { display: "block", color: "#555", fontSize: 10, letterSpacing: 2, marginBottom: 6 },
  input: { width: "100%", background: "#0F0F0F", border: "1px solid #1A1A1A", color: "#AAA", fontSize: 13, padding: "10px 14px", fontFamily: "Inter, sans-serif", outline: "none", boxSizing: "border-box" },
  textarea: { width: "100%", background: "#0F0F0F", border: "1px solid #1A1A1A", color: "#AAA", fontSize: 13, padding: "10px 14px", fontFamily: "Inter, sans-serif", outline: "none", resize: "vertical", boxSizing: "border-box" },
